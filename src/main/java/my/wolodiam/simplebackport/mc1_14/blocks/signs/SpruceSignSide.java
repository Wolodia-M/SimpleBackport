...
public class SpruceSignSide extends SignBlock {
    ...
    public SpruceSignSide(String name) {
        super();
        this.setHardness(1);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else
        {
            ...
            return tileentity instanceof SpruceSignTE ? ((SpruceSignTE)tileentity).executeCommand(playerIn) : false;
        }
    }
    ...
    {
        drops.add(new ItemStack(ItemRegister.get("spruce_sign"), 1));
    }
}
