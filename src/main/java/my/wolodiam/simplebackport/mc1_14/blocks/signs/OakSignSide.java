...
public class OakSignSide extends SignBlock {
    ...
    public OakSignSide(String name) {
        super();
        this.setHardness(1);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else
        {
            ...
            return tileentity instanceof OakSignTE ? ((OakSignTE)tileentity).executeCommand(playerIn) : false;
        }
    }
    ...
    {
        drops.add(new ItemStack(ItemRegister.get("oak_sign"), 1));
    }
}
