...
public class BirchSignSide extends SignBlock {
    ...
    public BirchSignSide(String name) {
        super();
        this.setHardness(1);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else
        {
            ...
            return tileentity instanceof BirchSignTE ? ((BirchSignTE)tileentity).executeCommand(playerIn) : false;
        }
    }
    ...
    {
        drops.add(new ItemStack(ItemRegister.get("birch_sign"), 1));
    }
}
