...
public class JungleSignSide extends SignBlock {
    ...
    public JungleSignSide(String name) {
        super();
        this.setHardness(1);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        else
        {
            ...
            return tileentity instanceof JungleSignTE ? ((JungleSignTE)tileentity).executeCommand(playerIn) : false;
        }
    }
    ...
    {
        drops.add(new ItemStack(ItemRegister.get("jungle_sign"), 1));
    }
}
