...
public class ClientProxy extends CommonProxy {
    ...
    public void registerTEModels() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(AcaciaSignTE.class, new SignRenderer("textures/sign/acacis_sign.png", BlockRegister.get("acacia_sign_top"), BlockRegister.get("acacia_sign_side")));
