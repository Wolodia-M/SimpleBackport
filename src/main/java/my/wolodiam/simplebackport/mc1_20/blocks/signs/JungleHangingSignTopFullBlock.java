...
public class JungleHangingSignTopFullBlock extends SignBlock {
    public static final PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
    public JungleHangingSignTopFullBlock(String name) {
        super();
        this.setHardness(1);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            return tileentity instanceof JungleHangingSignTE ? ((JungleHangingSignTE)tileentity).executeCommand(playerIn) : false;
        }
    }
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new JungleHangingSignTE();
    }
    ...
    {
        drops.add(new ItemStack(ItemRegister.get("jungle_hanging_sign"), 1));
    }
}
