...
public class HangingSignSideModel extends ModelBase {
    ...
    public HangingSignSideModel() {
        ...
        this.signBoard.addBox(1F, -5.0F, -1.0F, 24, 12, 2, 0.0F);
        // Two chain connectors of sign
        this.signChains[0] = new ModelRenderer(this, 0, 14);
        this.signChains[1] = new ModelRenderer(this, 0, 14);
        this.signChains[0].addBox(-12F, -20F, -1F, 7, 3, 2, 0.0F);
        this.signChains[1].addBox(-12F, -10F, -1F, 7, 3, 2, 0.0F);
        // Stick for side connection
        this.signStick = new ModelRenderer(this, 0, 20);
        this.signStick.addBox(-1F, -14F, -1F, 24, 2, 2, 0F);
    }
